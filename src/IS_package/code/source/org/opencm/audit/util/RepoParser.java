...
public class RepoParser {
	...
	public static LinkedList<AssertionValue> getAssertionValues(Configuration opencmConfig, Node opencmNode, Property propConfig, LinkedList<PropertyFilter> filters) {
		...
		if (opencmNode.getRepositoryType().equals(Configuration.OPENCM_DEFAULT_DIR)) {
			nodeDirectory = new File(PackageUtils.getPackageResourcePath() + File.separator + Configuration.OPENCM_DEFAULT_DIR + File.separator + Configuration.OPENCM_REFERENCE_DIR_PREFIX + opencmNode.getNode_name());
		} else {
	...
	public static String getDefaultValue(Configuration opencmConfig, AssertionValue av) {
		...
		String defaultRootDir = PackageUtils.getPackageResourcePath() + File.separator + Configuration.OPENCM_DEFAULT_DIR + File.separator + Configuration.OPENCM_REFERENCE_DIR_PREFIX + stVersion + File.separator;
